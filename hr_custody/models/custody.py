...
class HrCustody(models.Model):
    ...
    def _get_employee_id(self):
        ...
        return employee_rec.id or False
    ...
    employee = fields.Many2one('hr.employee', string='Employee', required=True, readonly=True, help="Employee",
                               states={'draft': [('readonly', False)]},default=_get_employee_id)
...
class HrPropertyName(models.Model):
    ...
    asset_id = fields.Many2one('account.asset.asset', string="Assets", help="Assets")
    ...
    def onchange_property_selection(self):
        if self.property_selection == 'asset':
            asset_obj = self.env['ir.module.module'].search([('name', '=', 'om_account_asset')])
