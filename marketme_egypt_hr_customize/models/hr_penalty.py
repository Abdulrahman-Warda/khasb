...
class HrPenalty(models.Model):
    ...
    @api.onchange('employee_id', 'penalty_type', 'daily_wage', 'amount', 'percent', 'days')
    def _get_total_amount(self):
        if self.employee_id and self.daily_wage and self.penalty_type:
            if self.penalty_type == 'amount':
                self.total_amount = self.amount
            elif self.penalty_type == 'percent':
                self.total_amount = self.daily_wage * self.percent
            elif self.penalty_type == 'days':
