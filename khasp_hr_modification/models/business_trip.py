...
class khasp_travel_allowances_modification(models.Model):
    _inherit = 'travel.allowances'
    ...
    def action_accounting_approve(self):
        res = super(khasp_travel_allowances_modification, self).action_accounting_approve()
        self.state = 'done'
        return res